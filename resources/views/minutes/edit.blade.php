	...
	<div class="row">
		<div class="col-md-8 col-md-offset-2">
			<div class="panel panel-default">
				<div class="panel-heading">Edit Minute</div>
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="col-md-12">
										<div class="form-group">
											<div class="col-md-12">
												{!! Form::text('title',$minute->title,array('class'=>"form-control",'placeholder'=>'Title','autocomplete'=>'off')) !!}
									...
									<div class="col-md-12">
										<div class="form-group">
											<div class="col-md-12">
												{!! Form::text('venue',$minute->venue,array('class'=>"form-control",'placeholder'=>'Venue','autocomplete'=>'off')) !!}
										...
										<div class="form-group">
											...
											<div class="col-md-6">
												<div id="colorpicker" data-color-format="rgb" data-color="rgb(255, 146, 180)">
													{!! Form::text('label',$minute->label,array('class'=>"form-control",'id'=>'label','autocomplete'=>'off','readonly'=>'readonly','onclick'=>"getcolor()")) !!}
												</div>
								...
								<div class="col-md-6" >
									...
									<div id="selected_minuter" class="col-md-12" >
										<h5>Minuters</h5>
										@if($minute->minuters)
											@foreach(explode(',',$minute->minuters) as $key => $value)
									...
									<div id="selected_attendees" class="col-md-12" >
										<h5>Attendees</h5>
										@if($minute->attendees)
											@foreach(explode(',',$minute->attendees) as $key => $value)
												<div class="col-md-6 attendees" id="u{{$value}}">
								...
								<div class="col-md-6 col-md-offset-6">
									<button id ="saveminute" type="submit" class="btn btn-primary">Update</button>
								</div>
								{!! Form::close() !!}
							</div>
						</div>
