...
@if($minute)
            ...
            <div class="meeting-new">
                <div class="meeting-new-title">
           		...
           		<div id="taskAddBlock">
	           		<div class="meeting-new-box taskBlock">
                ...
                <a id="add_more" class="btn-inter btn-add-meet">+ Add New</a>
            ...
            <div class="meeting-box">
                ...
                <div class="meeting-content">
                    ...
                    <div class="meeting-topic"><input type="text" class="meet-name" placeholder="Topic" value="{{ $task->title }}"></div>
                    ...
                    <div class="meeting-desc"><textarea class="meet-textarea" placeholder="Meeting Description">{!!$task->description!!}</textarea></div>
                </div>
            </div>
            @endforeach
 ...
 -->
        ...
        @endif
        <a id="add_more" class="btn-inter btn-add-meet">Submit</a>
        </div>
